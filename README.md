...
1. Download this [file](http://ds-old.gemsite.org/download_get.php?get=download/dragfix.zip&id=41) ([alternate link](https://web.archive.org/web/20060217005250/https://www.htheking.de/dragfix.zip)).2. Extract it to [\<path-to-game\>](#glossary)`\Resources`.
...
Download and run the [DS2 reg patch](https://github.com/GenesisFR/RegPatches) from [\<path-to-game\>](#glossary) (select option 1).
...
- [Official Multiplayer FAQ](https://web.archive.org/web/20070610102511/http://garage.gaspowered.com/?q=dsiimulti)
- [SiegeTheDay](https://www.siegetheday.org) (unofficial community)
- [Steam thread](https://steamcommunity.com/app/39200/discussions/0/2800629075205408338)
...
- [Zhixalom's Lair](https://www.zhixalom.com/lair/category/dungeon-siege-2) (DS2/BW mods)
